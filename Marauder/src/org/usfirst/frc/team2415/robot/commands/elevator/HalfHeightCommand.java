 ...
 *
 */
public class HalfHeightCommand extends Command {
    ...
    protected void execute() {
    	...
    	double output = Robot.elevatorSubsystem.basicPID.getPIDOutput(current, Robot.elevatorSubsystem.getHalfHeight());
